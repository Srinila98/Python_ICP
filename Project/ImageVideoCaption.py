...
gui = tkinter.Tk()
gui.title("Automatic Image and Video Caption Generation With Deep Learning: A Concise Review and Algorithmic Overlap") 
...
def loadModel():
    ...
    text.insert(END,'Image Caption RNN Encoder & Decoder Model Loaded\n\n')
...
font = ('times', 16, 'bold')
title = Label(gui, text='Automatic Image and Video Caption Generation With Deep Learning: A Concise Review and Algorithmic Overlap')
...
font1 = ('times', 12, 'bold')
loadButton = Button(gui, text="Load RNN,CNN & LSTM Model", command=loadModel)
loadButton.place(x=50,y=100)
loadButton.config(font=font1)  

uploadButton = Button(gui, text="Upload Image & Automatic Caption Generation", command=uploadImage)
uploadButton.place(x=50,y=150)
uploadButton.config(font=font1) 

descButton = Button(gui, text="Upload Video & Automatic Caption Generation", command=uploadVideo)
